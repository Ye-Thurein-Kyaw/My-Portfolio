...
const Contact = () => {
    return (
        <div className='max-w-[1240px] mx-auto bg-black sm:py-20 p-5' id='contact'>
            ...
            <div class='max-w-[800px] mx-auto'>
                ...
                <div class='mt-6 bg-[#161616] rounded-xl'>
                    <div class='p-10'>
                        ...
                        <form action="https://getform.io/f/navvwqja" method='POST'>
                            <div class='grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4'>
                                ...
                                <div class='sm:col-span-2'>
                                    <button type='submit' 
                                            class='text-xl w-full p-4 mt-2 text-white bg-primary-color rounded-md'>
                                        Send
                                    </button>
                                </div>
