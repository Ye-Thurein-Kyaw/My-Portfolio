...
const Hero = () => {
    return (
        <div className='grid grid-cols-1 mt-7 md:grid-cols-3 gap-8 max-w-[1240px] md:h-[70vh] mx-auto py-8 bg-black'>

            <div className='col-span-1 my-auto mx-auto w-[300px] h-auto lg:w-[200px]'>
            ...
            <div className='col-span-2 px-5 my-auto'>
                ...
                <p className='text-white sm:text-lg my-6 lg:text-xl'>
                    My name is Ye Thurein Kyaw and I have 1+ years of experience in Mobile development.
                </p>
